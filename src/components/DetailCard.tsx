    ...
    <div className="card">
      ...
      <div className="detail-grid">
        ...
        {row(
          "전체 전적",
          summary
            ? `${summary.total_wins}승 ${summary.draws}무 ${Math.max(0, summary.total_games - summary.total_wins - summary.draws)}패`
            : "-",
        )}
        ...
        {row("평균 MVP 지수", overview?.avg_mvp != null ? overview.avg_mvp : "-")}
